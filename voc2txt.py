...
xml = Path(r"C:\Users\62852\Documents\GitHub\Object-Tagging-PascalVOC-export\Annotations") #C:\Users\62852\Documents\GitHub\Object-Tagging-PascalVOC-export\Annotations\
xmls = os.listdir(xml)
xmls = [f for f in xmls if f.split(".")[-1] == "xml"]

txt_path = Path(r"C:\Users\62852\Documents\GitHub\Object-Tagging-PascalVOC-export\txt")
